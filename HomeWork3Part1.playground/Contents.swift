...
while counter < cart.count {
    count += 1
    print("----------------- \(count) -----------------------------")
    print("Назва товару: \(cart[counter].0)\nЦіна: \(cart[counter].1) \(cart[counter].2)")
    print("--------------------------------------------------")
    counter+=1
}
...
for product in cart {
    if product.1 < 5000.00 && product.3 == "s1151" {
        count += 1
        print("----------------- \(count) -----------------------------")
        print("Назва товару: \(product.0), Ціна: \(product.1) ₴\nСокет: \(product.3)")
        print("--------------------------------------------------")
    }
}
...
print("\n")
count = 0
func printInetelProducts() {
    print("-------------- Inetel --------------------------")
    for product in cart {
        if product.4.contains("Intel") {
            count += 1
...
func printProducts(maxPrice: Double) {
    ...
    for product in cart {
        if product.1 < maxPrice {
            count += 1
            print("\(count) Назва товару: \(product.0), Ціна: \(product.1) ₴")
        }
    }
    print("------------------------------------------------------------------------")
}
...
func printBestProduct(processor: String) -> ProductInfo? {
    var cartInfo: ProductInfo?
    var maxSize = cart[0].1
    
    for product in cart {
        if product.4 == processor {
            if product.1 > maxSize {
                cartInfo = product
            }
        }
    }
...
let cartInfo = printBestProduct(processor: "Intel")

if let cartInfo = cartInfo {
    print("------------------ Найдорожчий товар за процесором \(cartInfo.4) -----------------------------")
    print("Назва товару: \(cartInfo.0), Ціна: \(cartInfo.1) \(cartInfo.2)")
    print("--------------------------------------------------------------------------------------")
}
...
product.motherBoard.socket = "sAM8"
